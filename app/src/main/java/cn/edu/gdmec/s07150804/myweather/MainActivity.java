...
public class MainActivity extends AppCompatActivity {
 private MainActivity seft;
    ...
    private void initChooseDialog(){
        ...
        provice_spinner=(Spinner)choose_layout.findViewById(R.id.province_spinner);
        ArrayAdapter<String> provinceAdapter=new ArrayAdapter<String>(this,
                R.layout.simple_list_item,new ArrayList<String>
                (cityMap.keySet()));
        provice_spinner.setAdapter(provinceAdapter);
        city_spiner=(Spinner)choose_layout.findViewById(R.id.city_spinner);
        provice_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
String province_name=provice_spinner.getSelectedItem().toString();
                ArrayAdapter<String> cityAdapter=new ArrayAdapter<String>(seft,
                        R.layout.simple_list_item,cityMap.get(province_name));
...
choose_dialog.setView(choose_layout);
    ...
    private class ChooseCityListenner implements DialogInterface.OnClickListener{
        ...
        public void onClick(DialogInterface dialog, int which) {
            String city_name=city_spiner.getSelectedItem().toString();
